...
* ```protein_db```, Phage protein database dir; the phage protein database file can be download from [google driver](https://drive.google.com/drive/folders/1d9_86GQAEBj2EZrPQ4DzXxM7LrsSIQ2v?usp=sharing)
